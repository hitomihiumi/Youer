...
public class WorldBackup {
    ...
    private static void doBackup() throws IOException {
        // Youer - ServerLevel has no `name` field in 1.21.8; the overworld's folder is the world container
        Path worldPath = MinecraftServer.getServer().getLevel(Level.OVERWORLD).getWorld().getWorldFolder().toPath();
