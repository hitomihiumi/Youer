...
public class EntityClassLookup {
    ...
    static {
        ...
        add(AbstractVillager.class, new EntityClass<>(org.bukkit.entity.AbstractVillager.class, com.mohistmc.youer.bukkit.entity.YouerModsAbstractVillager.class, com.mohistmc.youer.bukkit.entity.YouerModsAbstractVillager::new)); // Youer - CraftAbstractVillager is abstract in 1.21.8
        add(AbstractArrow.class, new EntityClass<>(org.bukkit.entity.AbstractArrow.class, com.mohistmc.youer.bukkit.entity.YouerModsAbstractArrow.class, com.mohistmc.youer.bukkit.entity.YouerModsAbstractArrow::new)); // Youer - CraftAbstractArrow is abstract in 1.21.8
        ...
        // Youer - 1.21.5 removed FlyingMob (Ghast extends Mob directly) and with it CraftFlying, so
        // there is no longer a handle type to key org.bukkit.entity.Flying on.
        ...
        add(AbstractBoat.class, new EntityClass<>(org.bukkit.entity.Boat.class, com.mohistmc.youer.bukkit.entity.YouerModsBoat.class, com.mohistmc.youer.bukkit.entity.YouerModsBoat::new)); // Youer - 1.21.2 split Boat into per-wood types under AbstractBoat, and CraftBoat is abstract
        add(LlamaSpit.class, new EntityClass<>(org.bukkit.entity.LlamaSpit.class, CraftLlamaSpit.class, CraftLlamaSpit::new));
        add(AbstractChestBoat.class, new EntityClass<>(org.bukkit.entity.ChestBoat.class, com.mohistmc.youer.bukkit.entity.YouerModsChestBoat.class, com.mohistmc.youer.bukkit.entity.YouerModsChestBoat::new)); // Youer - see AbstractBoat above
        ...
        // Youer - 1.21.5 split ThrownPotion into ThrownSplashPotion and ThrownLingeringPotion, and made
        // CraftThrownPotion abstract, so the two concrete handles are keyed separately.
        add(ThrownSplashPotion.class, new EntityClass<>(org.bukkit.entity.SplashPotion.class, CraftThrownSplashPotion.class, CraftThrownSplashPotion::new));
        add(ThrownLingeringPotion.class, new EntityClass<>(org.bukkit.entity.LingeringPotion.class, CraftThrownLingeringPotion.class, CraftThrownLingeringPotion::new));
