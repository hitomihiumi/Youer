...
public record MohistSpecialIngredient(Ingredient ingredient) implements RecipeChoice {
    ...
    public ItemStack getItemStack() {
        // Youer - Ingredient#getItems is gone; items() is a Stream<Holder<Item>> in 1.21.5+
        net.minecraft.world.item.ItemStack[] items = ingredient.items().map(net.minecraft.core.Holder::value).map(net.minecraft.world.item.ItemStack::new).toArray(net.minecraft.world.item.ItemStack[]::new);
