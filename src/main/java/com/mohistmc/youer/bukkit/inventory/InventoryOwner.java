...
public class InventoryOwner {
    ...
    public static InventoryHolder get(Level world, BlockPos pos) {
        ...
        if (state instanceof InventoryHolder) {
            ...
            BlockEntity te = ((org.bukkit.craftbukkit.CraftWorld) blockEntityState.getWorld()).getHandle().getBlockEntity(org.bukkit.craftbukkit.util.CraftLocation.toBlockPosition(blockEntityState.getLocation())); // Youer - CraftBlockEntityState#getTileEntity is gone
