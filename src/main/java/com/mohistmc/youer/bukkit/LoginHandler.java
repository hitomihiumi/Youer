...
public class LoginHandler {
    ...
    public static GameProfile callPlayerPreLoginEvents(ServerLoginPacketListenerImpl serverLoginPacketListener, GameProfile gameprofile) throws Exception {
        ...
        AsyncPlayerPreLoginEvent asyncEvent = new AsyncPlayerPreLoginEvent(playerName, address, rawAddress, uniqueId, serverLoginPacketListener.transferred, profile, serverLoginPacketListener.connection.hostname, serverLoginPacketListener.paperLoginConnection); // Youer - Paper added the login-connection parameter
