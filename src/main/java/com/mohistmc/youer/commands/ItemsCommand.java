...
public class ItemsCommand extends Command {
    ...
    public static void info(Player player) {
        ...
        try{
            net.minecraft.nbt.CompoundTag nbt = com.mohistmc.youer.api.ItemAPI.saveItem(nmsItem, PlayerAPI.getNMSPlayer(player).registryAccess()); // Youer - ItemStack#save is gone in 1.21.5
